...
import { expressionToEntityName } from "./expand-util.js"
import { anyConstructorName, type ResolvedMixinRef } from "./model.js"
...
// The SOURCE-VIEW "navigable base" fast path of the consumer expansion: the consumer
// re-extends the real base under a single-source cast, with every token of the source
// base expression position-pinned so navigation lands on the real base class instead of
// a generated `$base`. The emit-plane heritage builders (and the shared cast heads /
// statics bags this module reuses) live in `consumer-base-heritage.ts`.
