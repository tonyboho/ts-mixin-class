...
- f7fa11a: Base-less consumers now reuse a mixin's canonical application instead of each growing its
...
- 529f61c: Faster per-file transform. The compile-time C3 linearization now caches the merge of a
